...
function MobileNavigation() {
  return (
    <Popover>
      ...
      >
        <MobileNavLink href="#features">Функции</MobileNavLink>
        <MobileNavLink href="#testimonials">Отзывы</MobileNavLink>
        <MobileNavLink href="#pricing">Стоимость</MobileNavLink>
      </PopoverPanel>
    </Popover>
  )
}
        ...
        <nav className="relative z-50 flex justify-between">
          <div className="flex items-center md:gap-x-12">
            ...
            <div className="hidden md:flex md:gap-x-6">
              <NavLink href="#features">Функции</NavLink>
              <NavLink href="#testimonials">Отзывы</NavLink>
              <NavLink href="#pricing">Стоимость</NavLink>
            </div>
          </div>
          <div className="flex items-center gap-x-5 md:gap-x-8">

            <Button href="https://t.me/TigrisConnectBot" color="blue">
              <span>
                Начать в Telegram
              </span>
            </Button>
